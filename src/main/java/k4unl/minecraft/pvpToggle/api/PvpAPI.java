...
public class PvpAPI {
    ...
    public static void init(IPvpToggleApi inst) {
        ...
        if (instance == null && ModLoadingContext.get().getActiveContainer().getModId().equalsIgnoreCase(ModInfo.ID)) {
            instance = inst;
    ...
    public interface IPvpToggleApi {
         ...
         * @param toSet
         */
        void setDimensionSetting(DimensionType dimension, PvPStatus toSet) throws IncorrectStatusException;
         ...
         * @param announce
         */
        void createNewArea(String areaName, BlockPos location1, BlockPos location2, DimensionType dimension, PvPStatus toSet, boolean announce) throws
         ...
         * @throws NoAreaFoundException
         */
        DimensionType getDimensionFromArea(String areaName) throws NoAreaFoundException;
