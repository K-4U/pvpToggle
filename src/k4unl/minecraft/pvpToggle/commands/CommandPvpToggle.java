...
public class CommandPvpToggle extends CommandK4OpOnly {
    ...
    private void handleAreaCommand(ICommandSender sender, String[] args){
        if(args[1].toLowerCase().equals("new")){
            ...
            if(args.length < 9){
                sender.addChatMessage(new ChatComponentText(EnumChatFormatting.RED + "Usage: /pvptoggle area new <name> <x1> <y1> <z1> <x2> <y2> <z2>"));
                return;
            }else{
                ...
                PvPArea newArea = new PvPArea(args[2].toLowerCase(), loc1, loc2, sender.getEntityWorld().provider.getDimensionId());
        ...
        if(args[1].toLowerCase().equals("delete")){
            if(args.length >= 3){
                ...
                if(theArea == null){
                    sender.addChatMessage(new ChatComponentText(EnumChatFormatting.RED + "This area cannot be found!"));
                    return;
                }
            ...
            if(args.length >= 5) {
                if (args[2].toLowerCase().equals("get")) {
                    ...
                    if(args[4].toLowerCase().equals("announce")) {
                        ...
                        sender.addChatMessage(new ChatComponentText(EnumChatFormatting.RED + "Valid options: announce or forced"));
                    }
                }
                ...
                sender.addChatMessage(new ChatComponentText(EnumChatFormatting.RED + "Usage: /pvptoggle area options <name> [get/set] <optionName> "
                  + "[newValue]"));
            }
        }
    }
